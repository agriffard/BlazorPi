...
namespace BlazorPi.Client.Pages
{
    public class PiTestModel : BlazorComponent
    {
        ...
        public ElementRef TestSpan;
        protected override void OnAfterRender()
        {
            Microsoft.AspNetCore.Blazor.Browser.Interop.RegisteredFunction.Invoke<bool>("RawHtml", TestSpan, Test.Replace(Environment.NewLine, "<br>"));
        }
